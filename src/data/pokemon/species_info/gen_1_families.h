...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_DROUGHT, ABILITY_SOLAR_POWER, ABILITY_SOLAR_POWER },
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_DRIZZLE, ABILITY_RAIN_DISH, ABILITY_RAIN_DISH },
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_DRIZZLE, ABILITY_MEGA_LAUNCHER, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
